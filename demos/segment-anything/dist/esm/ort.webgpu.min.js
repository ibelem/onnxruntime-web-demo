...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let t=r=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(r)];return this.uniforms.map(r=>[t(r.type),r.length??1])}},is=(e,t)=>new Zi(e,t),Ir=(e,t)=>{let r=e.length,n=[];for(let i=0;i<r;i++){let s=r-1-i,o=e[s]||1;(t[t.length-1-i]||1)>1&&o===1&&n.unshift(s)}return n}});var xc,as,Cc,Ic,St,os,ss,Ar=j(()=>{"use strict";me();Se();Ye();$e();xc=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},as=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,Cc=(e,t)=>D.sortBasedOnPerm(e,as(e.length,t)),Ic=(e,t,r,n)=>{let i=[];i.push(`fn perm(i: ${n.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let s=0;s<t;++s)i.push(r.indicesSet("a",e[s],`i[${s}]`));return i.push("return a;}"),i.join(`
`)},St=(e,t)=>{let r=e.dataType,n=e.dims.length,i=as(n,t),s=Cc(e.dims,i),o=K("output",r,s.length),d=M("a",r,n),p=m=>`
...
var best_index : i32 = 0;`,`if (${n.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`}},Ds=e=>{rp(e.inputs),e.compute(np(e.inputs))}});var ip,Re,Us,Ws,Ns,Vs,Gs,Hs,Ls,Fs,qs,ap,js,Ks,Ys,Xs,ei,Zs,ti,Qs,Js,eu,tu,ru,nu,iu,au,ou,su,uu,lu,du,cu,pu,fu,mu,hu,na,ia,gu,yu,bu,ri=j(()=>{"use strict";me();Se();Ye();$e();ip=(e,t,r,n,i,s)=>{let o=Math.ceil(t/4),d="";typeof i=="string"?d=`${i}(a)`:d=i("a");let p=M("inputData",r,[o],4),m=K("outputData",n,[o],4);return`
  ...
  }`},Re=(e,t,r,n,i,s=e.dataType)=>({name:t,shaderCache:{hint:i,inputDependencies:["type"]},getShaderSource:o=>ip(o,D.size(e.dims),e.dataType,s,r,n),getRunData:o=>({outputs:[{dims:e.dims,dataType:s}],dispatchGroup:{x:Math.ceil(D.size(o[0].dims)/64/4)},programUniforms:[{type:12,data:Math.ceil(D.size(e.dims)/4)}]})}),Us=e=>{e.compute(Re(e.inputs[0],"Abs","abs"))},Ws=e=>{e.compute(Re(e.inputs[0],"Acos","acos"))},Ns=e=>{e.compute(Re(e.inputs[0],"Acosh","acosh"))},Vs=e=>{e.compute(Re(e.inputs[0],"Asin","asin"))},Gs=e=>{e.compute(Re(e.inputs[0],"Asinh","asinh"))},Hs=e=>{e.compute(Re(e.inputs[0],"Atan","atan"))},Ls=e=>{e.compute(Re(e.inputs[0],"Atanh","atanh"))},Fs=e=>we(e),qs=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(Re(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},ap=e=>{let t=e.length>=2&&e[1].data!==0?e[1].getFloat32Array()[0]:Kn,r=e.length>=3&&e[2].data!==0?e[2].getFloat32Array()[0]:Yn;return we({min:t,max:r})},js=(e,t)=>{let r=e.inputs.length===1?t:ap(e.inputs),n=pt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"Clip",i=>`clamp(${i}, clip_min_, clip_max_)`,`
    const clip_min_: vec4<${n}> = vec4(${n}(${r.min}));
    const clip_max_: vec4<${n}> = vec4(${n}(${r.max}));
`,r.cacheKey),{inputs:[0]})},Ks=e=>{e.compute(Re(e.inputs[0],"Ceil","ceil"))},Ys=e=>{e.compute(Re(e.inputs[0],"Cos","cos"))},Xs=e=>{e.compute(Re(e.inputs[0],"Cosh","cosh"))},ei=e=>we(e),Zs=(e,t)=>{let r=pt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"Elu",n=>`elu_vf32(${n})`,`
...
}`,Qs=e=>{let t=pt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,ti(t)))},Js=e=>{e.compute(Re(e.inputs[0],"Exp","exp"))},eu=e=>{e.compute(Re(e.inputs[0],"Floor","floor"))},tu=e=>{let t=pt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,ti(t)))},ru=(e,t)=>{let r=pt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"LeakyRelu",n=>`select(leaky_relu_alpha_ * ${n}, ${n}, ${n} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},nu=e=>{e.compute(Re(e.inputs[0],"Not",t=>`!${t}`))},iu=e=>{e.compute(Re(e.inputs[0],"Neg",t=>`-${t}`))},au=e=>{e.compute(Re(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},ou=e=>{let t=pt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},su=e=>{e.compute(Re(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},uu=e=>we(e),lu=(e,t)=>{let r=pt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"HardSigmoid",n=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${n} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},du=e=>{e.compute(Re(e.inputs[0],"Sin","sin"))},cu=e=>{e.compute(Re(e.inputs[0],"Sinh","sinh"))},pu=e=>{e.compute(Re(e.inputs[0],"Sqrt","sqrt"))},fu=e=>{e.compute(Re(e.inputs[0],"Tan","tan"))},mu=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,hu=e=>{e.compute(Re(e.inputs[0],"Tanh",mu))},na=(e="f32")=>`
...
`,ia=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,gu=e=>{let t=pt(e.inputs[0].dataType);e.compute(Re(e.inputs[0],"FastGelu",ia,na(t),void 0,e.inputs[0].dataType))},yu=(e,t)=>{let r=pt(e.inputs[0].dataType);return e.compute(Re(e.inputs[0],"ThresholdedRelu",n=>`select(vec4<${r}>(0.0), ${n}, ${n} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`,t.cacheKey)),0},bu=e=>{e.compute(Re(e.inputs[0],"Log","log"))}});var op,sp,vu,$u=j(()=>{"use strict";Se();$e();ri();op=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},sp=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=M("input",e[0].dataType,e[0].dims,4),n=M("bias",e[0].dataType,[e[0].dims[2]],4),i=K("output",e[0].dataType,t,4),s=D.size(t)/4,o=De(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:p=>`
  ...
  ${p.mainStart()}
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},Au=e=>{Wt(e,"Sub",(t,r)=>`${t}-${r}`)},Tu=e=>{Wt(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},Eu=e=>{Wt(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},Ou=e=>{Wt(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},ku=e=>{Wt(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}});var cp,pp,fp,mp,Ru,zu,Bu=j(()=>{"use strict";me();Se();Ye();$e();cp=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let r=0,n=e[r],i=n.dataType,s=n.dims.length;e.forEach((o,d)=>{if(d!==r){if(o.dataType!==i)throw new Error("input tensors should be one type");if(o.dims.length!==s)throw new Error("input tensors should have the same shape");o.dims.forEach((p,m)=>{if(m!==t&&p!==n.dims[m])throw new Error("non concat dimensions must match")})}})},pp=(e,t)=>`
...
`});var hp,gp,rn,Du,yp,nn,bp,si,an=j(()=>{"use strict";me();Se();$e();Xt();ai();hp=(e,t)=>e?`
        ...
        }`,rn=(e,t,r="f32",n,i=!1,s=32,o=!1,d=32)=>{let p=t[1]*e[1],m=t[0]*e[0],l=i?p:s,g=i?s:p,b=l/t[0],$=s/t[1];if(!((i&&b===4&&e[1]===4||!i&&(b===3||b===4))&&l%t[0]===0&&s%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${i} is true, innerElementSize ${b} and workPerThread[1] ${e[1]} must be 4.
...
`}return ue};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${l};${g};${b};${i}`,inputDependencies:v?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil($/64)},programUniforms:x}),getShaderSource:O}},vp=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},Vu=e=>{vp(e.inputs);let t=zt.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let r=t[t.length-1],n=e.inputs[0].dims[e.inputs[0].dims.length-1];r<8&&n<8?e.compute(ua(e.inputs,{activation:""},t)):e.compute(si(e.inputs,{activation:""},t))}});var ui,da,$p,Gu,ca,_p,Sp,pa,sa=j(()=>{"use strict";Se();Uu();an();Nu();Xt();la();Ar();ui=(e,t,r,n,i,s)=>{let o=e[0],d=e.slice(s?1:2,s?3:4),p=d.length,m=t[0],g=t.slice(2).map((v,S)=>v+(v-1)*(r[S]-1)),$=d.map((v,S)=>v+n[S]+n[S+p]).map((v,S)=>Math.floor((v-g[S]+i[S])/i[S]));return $.splice(0,0,o),$.splice(s?3:1,0,m),$},da=[2,3,1,0],$p=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support conv 1D and 2D");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],n=e[1].dims[1]*t.group;if(r!==n)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let i=e[0].dims.length-2;if(t.dilations.length!==i)throw new Error(`dilations should be ${i}D`);if(t.strides.length!==i)throw new Error(`strides should be ${i}D`);if(t.pads.length!==i*2)throw new Error(`pads should be ${i*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Gu=(e,t)=>{let r=e.kernelShape.slice();for(let s=2;s<t[1].dims.length;++s)r[s-2]===0&&(r[s-2]=t[1].dims[s]);let n=e.pads.slice();lr.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,n,e.format==="NHWC",e.autoPad);let i=Object.assign({},e);return Object.assign(i,{kernelShape:r,pads:n}),i},ca=e=>{let t=ni(e),r=e.format,n=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],i=e.dilations,s=e.group,o=e.kernel_shape,d=e.pads,p=e.strides,m=e.w_is_const();return{autoPad:n,format:r,dilations:i,group:s,kernelShape:o,pads:d,strides:p,wIsConst:m,...t,cacheKey:`${e.format};${t.activation};`}},_p=(e,t,r)=>{let n=Gu(r,t),i=r.format==="NHWC";if(r.group!==1){if(!e.adapterInfo.isArchitecture("ampere")&&i&&t[1].dims[0]===r.group&&t[1].dims[1]===1&&r.dilations[0]===1&&r.dilations[1]===1){let V=ui(t[0].dims,t[1].dims,r.dilations,n.pads,r.strides,i),G=e.kernelCustomData.wT??e.compute(St(t[1],da),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=G);let ie=[t[0],G];t.length===3&&ie.push(t[2]),e.compute(Wu(ie,n,V),{inputs:ie})}else e.compute(oa(t,n));return}let s=t.length===3,o=t[0].dims[i?1:2],d=t[0].dims[i?2:3],p=t[0].dims[i?3:1],m=t[1].dims[2],l=t[1].dims[3],g=ui(t[0].dims,t[1].dims,r.dilations,n.pads,r.strides,i),b=g[i?1:2],$=g[i?2:3],v=g[i?3:1],S=i&&m===o&&l===d&&r.pads[0]===0&&r.pads[1]===0;if(S||m===1&&l===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let N=g[0],V,G,ie,Z=[];if(i){let Be=e.kernelCustomData.wT??e.compute(St(t[1],da),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=Be),S){let Oe=o*d*p;V=t[0].reshape([1,N,Oe]),G=Be.reshape([1,Oe,v]),ie=[1,N,v]}else V=t[0].reshape([N,o*d,p]),G=Be.reshape([1,p,v]),ie=[N,b*$,v];Z.push(V),Z.push(G)}else V=t[0].reshape([N,p,o*d]),G=t[1].reshape([1,v,p]),ie=[N,v,b*$],Z.push(G),Z.push(V);s&&Z.push(t[2]);let U=ie[2],re=Z[0].dims[Z[0].dims.length-1];U<8&&re<8?e.compute(ua(Z,n,g,ie,i),{inputs:Z}):e.compute(si(Z,n,g,ie,i),{inputs:Z});return}let T=!0,I=e.kernelCustomData.wT??e.compute(St(t[1],da),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=I);let x=[t[0],I];s&&x.push(t[2]);let O=i?b*$:v,A=i?v:b*$,P=m*l*p;e.compute(Mu(x,n,g,O,A,P,s,T),{inputs:x})},Sp=(e,t)=>{let r=t.format==="NHWC",n=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&n.push(e.inputs[2]);let i=[0,t.pads[0],0,t.pads[1]],s=[1].concat(t.strides),o=[1].concat(t.dilations),d=[1].concat(t.kernelShape),p=Gu({...t,pads:i,strides:s,dilations:o,kernelShape:d},n);e.compute(oa(n,p,m=>r?[m[0],m[2],m[3]]:[]))},pa=(e,t)=>{$p(e.inputs,t),e.inputs[0].dims.length===3?Sp(e,t):_p(e,e.inputs,t)}});var xp,Hu,Lu=j(()=>{"use strict";me();Yt();$e();Xt();ai();aa();an();xp=(e,t=!1,r,n,i=4)=>{let s=I=>{switch(I){case 1:return"return w[getIndexFromCoords4D(coord, vec4<i32>(uniforms.w_shape))];";case 4:return`
  ...
  fn mm_write(batch: i32, row : i32, colIn : i32, valueInput : ${n}) {
    ...
    if (row < uniforms.dim_a_outer && col < uniforms.dim_b_outer) {
      ...
      result[getIndexFromCoords4D(coords, vec4<i32>(uniforms.result_shape))/${i}] = value;
        ...
        ${v?rn(x,I,ue,void 0,!p,P):nn(x,I,ue,void 0,!p,P,!1,void 0,d)}`};return{name:"Conv2DTransposeMatMul",shaderCache:{hint:`${t.cacheKey};${x};${I};${v}`,inputDependencies:U},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:O[0],y:O[1],z:O[2]},programUniforms:Z}),getShaderSource:re}}});var Cp,fa,Fu=j(()=>{"use strict";me();Yt();Se();$e();Cp=(e,t,r,n,i,s=!1,o,d,p=!1)=>{let m=p?1:2,l=p?2:3,g=p?3:1,b=s?2:1,$=`
  ...
  ${s?O:A}}`},fa=(e,t,r)=>{let n=e.length>2,i=t.outputShape,s=D.size(i),o=[Math.ceil(s/64),1,1];Ne("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${o}`);let d=t.format==="NHWC",p=["rank","rank"],m=[t.strides[0],t.strides[1]],l=[t.kernelShape[d?1:2],t.kernelShape[d?2:3]],g=[t.dilations[0],t.dilations[1]],b=[l[0]+(t.dilations[0]<=1?0:(t.kernelShape[d?1:2]-1)*(t.dilations[0]-1)),l[1]+(t.dilations[1]<=1?0:(t.kernelShape[d?2:3]-1)*(t.dilations[1]-1))],$=[b[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),b[1]-1-Math.floor(t.pads[1]+t.pads[3])/2],v=!1,S=t.group,T=e[1].dims,I=T[0]/S,x=T[1],O=[{type:12,data:s},{type:12,data:m},{type:12,data:l},{type:12,data:g},{type:12,data:b},{type:6,data:$},{type:12,data:I},{type:12,data:x},...X(e[0].dims,e[1].dims)];n&&(O.push(...X(e[2].dims)),p.push("rank")),O.push(...X(i));let A=o[1]===1&&o[2]===1,P=N=>{let V=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:m.length},{name:"filter_dims",type:"u32",length:l.length},{name:"dilations",type:"u32",length:l.length},{name:"effective_filter_dims",type:"u32",length:b.length},{name:"pads",type:"i32",length:$.length},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],G=De(e[0].dataType);return`${Cp(N,e,i,n,A,v,G,V,d)}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};`,inputDependencies:p},getRunData:()=>({dispatchGroup:{x:o[0],y:o[1],z:o[2]},outputs:[{dims:r?r(i):i,dataType:e[0].dataType}],programUniforms:O}),getShaderSource:P}}});var Ip,Ap,Tp,qu,ju,Ep,Op,kp,Pp,Ku,Yu=j(()=>{"use strict";Lu();Fu();Xt();Ar();Ip=(e,t,r,n,i,s)=>(e-1)*t+r+(n-1)*i+1-s,Ap=(e,t,r,n,i)=>{let s=Math.floor(e/2);t==="SAME_UPPER"?(r[n]=s,r[i]=e-s):t==="SAME_LOWER"&&(r[n]=e-s,r[i]=s)},Tp=(e,t,r,n,i,s,o,d,p,m)=>{let l=e.length-2,g=m.length===0;if(p.length===0)for(let v=0;v<l;++v)p.push(0);let b=e[0],$=t[d?3:1]*i;for(let v=0,S=e.length-l-(d?1:0);v<l;++v,++S){let T=e[S],I=g?T*o[v]:m[v],x=Ip(T,o[v],s[v],t[S],r[v],I);Ap(x,n,s,v,v+l),g&&m.push(o[v]*(T-1)+p[v]+(t[S]-1)*r[v]+1-s[v]-s[v+l])}m.splice(0,0,b),m.splice(d?3:1,0,$)},qu=(e,t)=>{let r=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((g,b)=>g*b,1)===0){r.length=0;for(let g=2;g<t[1].dims.length;++g)r.push(t[1].dims[g])}let n=e.format==="NHWC";r.splice(0,0,t[1].dims[0]),r.splice(n?3:1,0,t[1].dims[1]);let i=e.pads.slice(),s=e.outputShape.slice(),o=e.outputPadding.slice(),d=t[0].dims,p=e.dilations.slice();if(p.reduce((g,b)=>g+b,0)===0){let g=t[0].dims.length-2;p=new Array(g).fill(1)}let m=e.strides.slice();if(m.reduce((g,b)=>g+b,0)===0){let g=t[0].dims.length-2;m=new Array(g).fill(1)}Tp(d,r,p,e.autoPad,e.group,i,m,n,o,s);let l=Object.assign({},e);return Object.assign(l,{kernelShape:r,pads:i,outputPadding:o,outputShape:s,dilations:p,strides:m}),l},ju=e=>{let t=ni(e),r=e.format,n=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],i=e.dilations,s=e.group,o=e.kernelShape,d=e.pads,p=e.strides,m=e.wIsConst(),l=e.outputPadding,g=e.outputShape;return{autoPad:n,format:r,dilations:i,group:s,kernelShape:o,outputPadding:l,outputShape:g,pads:d,strides:p,wIsConst:m,...t,cacheKey:`${e.format};${t.activation};`}},Ep=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],n=e[1].dims[0];if(r!==n)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let i=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==i))throw new Error("invalid bias");let s=e[0].dims.length-2;if(t.dilations.reduce((l,g)=>l+g,0)>0&&t.dilations.length!==s)throw new Error(`dilations should be ${s}D`);if(t.strides.reduce((l,g)=>l+g,0)>0&&t.strides.length!==s)throw new Error(`strides should be ${s}D`);if(t.pads.reduce((l,g)=>l+g,0)>0&&t.pads.length!==s*2)throw new Error(`pads should be ${s*2}D`);if(t.outputPadding.length!==s&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${s}D`);if(t.kernelShape.reduce((l,g)=>l+g,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},Op=[2,3,1,0],kp=(e,t,r)=>{let n=qu(r,t),i=r.format==="NHWC",s=n.outputShape,o=s[i?3:1],d=t[0].dims[i?3:1];if(n.group!==1||o===1&&d===1){e.compute(fa(t,n));return}let p=s[i?1:2],m=s[i?2:3],l=t[1].dims[2],g=t[1].dims[3],b=i?p*m:o,$=i?o:p*m,v=l*g*d,S=!0,T=e.kernelCustomData.wT??e.compute(St(t[1],Op),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=T);let I=[t[0],T],x=t.length===3;x&&(!i&&t[2].dims.length===1?I.push(t[2].reshape([t[2].dims[0],1,1])):I.push(t[2])),e.compute(Hu(I,n,s,b,$,v,x,S),{inputs:I})},Pp=(e,t)=>{let r=t.format==="NHWC",n=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&n.push(e.inputs[2]);let i=t.kernelShape;(i.length===0||i[0]===0)&&(i=[e.inputs[1].dims[2]]);let s=t.dilations;(s.length===0||s[0]===0)&&(s=[1]);let o=t.strides;(o.length===0||o[0]===0)&&(o=[1]);let d=t.pads;d.length===0&&(d=[0,0]),d=[0,d[0],0,d[1]],o=[1].concat(o),s=[1].concat(s),i=[1].concat(i);let p=qu({...t,pads:d,strides:o,dilations:s,kernelShape:i},n);e.compute(fa(n,p,m=>r?[m[0],m[2],m[3]]:[m[0],m[1],m[3]]))},Ku=(e,t)=>{Ep(e.inputs,t),e.inputs[0].dims.length===3?Pp(e,t):kp(e,e.inputs,t)}});var Rp,Xu,Zu,Qu=j(()=>{"use strict";me();Se();Ye();$e();Rp=(e,t,r,n)=>{let i=D.size(t),s=t.length,o=M("input",e,s),d=K("output",e,s),p=r.dataType===6?r.getInt32Array()[0]:Number(r.getBigInt64Array()[0]),m=D.normalizeAxis(p,s),l=g=>{let b=` i32(${o.indicesGet("inputIndices","uniforms.axis")}) `,$=se("uniforms.input_shape","uniforms.axis",s),v=n.reverse?b+(n.exclusive?" + 1":""):"0",S=n.reverse?$:b+(n.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:n.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:[{type:12,data:i},{type:6,data:m},...X(t,t)]}),getShaderSource:l}},Xu=(e,t)=>{let r=e.inputs[0].dims,n=e.inputs[0].dataType,i=e.inputs[1];e.compute(Rp(n,r,i,t),{inputs:[0]})},Zu=e=>{let t=e.exclusive===1,r=e.reverse===1;return we({exclusive:t,reverse:r})}});var ma,li,Ju,zp,Bp,ha,ga,el,Dp,tl,rl,nl=j(()=>{"use strict";me();Se();Ye();$e();ma="[a-zA-Z]|\\.\\.\\.",li="("+ma+")+",Ju="^"+li+"$",zp="("+li+",)*"+li,Bp="^"+zp+"$",ha=class{constructor(t=-1){this.symbolToIndices=new Map,this.inputIndex=t}addSymbol(t,r){let n=this.symbolToIndices.get(t);n===void 0?n=[r]:n.push(r),this.symbolToIndices.set(t,n)}},ga=class{constructor(t,r){this.equation=r;this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[n,i]=r.includes("->")?r.split("->",2):[r,""];if(!n.match(RegExp(Bp)))throw new Error("Invalid LHS term");if(n.split(",").forEach((d,p)=>{let m=t[p].dims.slice();if(!d.match(RegExp(Ju)))throw new Error("Invalid LHS term");let l=this.processTerm(d,!0,m,p);this.lhs.push(l)}),i==="")i+=[...this.symbolToInfo.entries()].filter(([d,p])=>p.count===1||d==="...").map(([d])=>d).join("");else if(!i.match(RegExp(li)))throw new Error("Invalid RHS");i.match(RegExp(ma,"g"))?.forEach(d=>{if(d==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let p=this.symbolToInfo.get(d);if(p===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(p.dimValue)}}),this.rhs=this.processTerm(i,!1,this.outputDims)}addSymbol(t,r,n){let i=this.symbolToInfo.get(t);if(i!==void 0){if(i.dimValue!==r&&i.count!==1)throw new Error("Dimension mismatch");i.count++,i.inputIndices.push(n)}else i={count:1,dimValue:r,inputIndices:[n]};this.symbolToInfo.set(t,i)}processTerm(t,r,n,i=-1){let s=n.length,o=!1,d=[],p=0;if(!t.match(RegExp(Ju))&&!r&&t!=="")throw new Error("Invalid LHS term");let m=t.match(RegExp(ma,"g")),l=new ha(i);return m?.forEach((g,b)=>{if(g==="..."){if(o)throw new Error("Only one ellipsis is allowed per input term");o=!0;let $=s-m.length+1;if($<0)throw new Error("Ellipsis out of bounds");if(d=n.slice(p,p+$),this.hasEllipsis){if(this.ellipsisDims.length!==d.length||this.ellipsisDims.toString()!==d.toString())throw new Error("Ellipsis dimensions mismatch")}else if(r)this.hasEllipsis=!0,this.ellipsisDims=d;else throw new Error("Ellipsis must be specified in the LHS");for(let v=0;v<d.length;v++){let S=String.fromCharCode("0".charCodeAt(0)+v);l.addSymbol(S,b+v),this.addSymbol(S,n[p++],i)}}else l.addSymbol(g,b+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(g,n[p++],i)}),l}},el=e=>e+"_max",Dp=(e,t,r,n)=>{let s=e.map(l=>l.length).map((l,g)=>M(`input${g}`,t,l)),o=D.size(n),d=K("output",t,n.length),p=[...r.symbolToInfo.keys()].filter(l=>!r.rhs.symbolToIndices.has(l)),m=l=>{let g=[],b="var prod = 1.0;",$="var sum = 0.0;",v="sum += prod;",S=[],T=[],I=[],x=[],O=r.symbolToInfo.size===r.rhs.symbolToIndices.size;r.symbolToInfo.forEach((P,N)=>{if(r.rhs.symbolToIndices.has(N)){let V=r.rhs.symbolToIndices.get(N)?.[0];V!==void 0&&r.lhs.forEach((G,ie)=>{if(P.inputIndices.includes(ie)){let Z=G.symbolToIndices.get(N);if(Z===void 0)throw new Error("Invalid symbol error");Z.forEach(U=>{g.push(`${s[ie].indicesSet(`input${ie}Indices`,U,d.indicesGet("outputIndices",V))}`)})}})}else r.lhs.forEach((V,G)=>{if(P.inputIndices.includes(G)){let ie=V.symbolToIndices.get(N);if(ie===void 0)throw new Error("Invalid symbol error");ie.forEach(Z=>{S.push(`${s[G].indicesSet(`input${G}Indices`,Z,`${N}`)}`)}),x.push(`prod *= ${s[G].getByIndices(`input${G}Indices`)};`)}}),T.push(`for(var ${N}: u32 = 0; ${N} < uniforms.${el(N)}; ${N}++) {`),I.push("}")});let A=O?[...g,`let sum = ${s.map((P,N)=>P.getByIndices(`input${N}Indices`)).join(" * ")};`]:[...g,$,...T,...S,b,...x,v,...I];return`
            ${l.registerUniforms(p.map(P=>({name:`${el(P)}`,type:"u32"}))).registerUniform("outputSize","u32").declareVariables(...s,d)}
...
`)};
            ${d.setByOffset("global_idx","sum")};
          }`};return{name:"Einsum",shaderCache:{hint:r.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let l=p.filter(b=>r.symbolToInfo.has(b)).map(b=>({type:12,data:r.symbolToInfo.get(b)?.dimValue||0}));l.push({type:12,data:o});let g=e.map((b,$)=>[...X(b)]).reduce((b,$)=>b.concat($),l);return g.push(...X(n)),{outputs:[{dims:n,dataType:t}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:g}},getShaderSource:m}},tl=(e,t)=>{let r=new ga(e.inputs,t.equation),n=r.outputDims,i=e.inputs.map((s,o)=>s.dims);e.compute(Dp(i,e.inputs[0].dataType,r,n))},rl=e=>{let t=e.equation.replace(/\s+/g,"");return we({equation:t})}});var Mp,il,Up,Wp,al,ol=j(()=>{"use strict";me();Se();$e();Mp=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),n=r.length<t.length?0:r.length-t.length,i=t.length<r.length?0:t.length-r.length;for(;n<r.length&&i<t.length;++n,++i)if(r[n]!==t[i]&&r[n]!==1&&t[i]!==1)throw new Error("Expand requires shape to be broadcastable to input")},il=(e,t)=>{let r=e.length-t.length,n=[];for(let i=0;i<r;++i)n.push(e[i]);for(let i=0;i<t.length;++i)n.push(t[i]===1?e[i+r]:t[i]);return n},Up=(e,t)=>e.length>t.length?il(e,t):il(t,e),Wp=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),n=Up(t,r),i=e[0].dataType,s=i===9?4:1,o=Math.ceil(D.size(n)/s),d=m=>{let l=M("input",i,t.length,s),g=K("output",i,n.length,s),b;if(i===9){let $=(v,S,T="")=>`
    ...
    ${b}`},p=[{type:12,data:o},...X(t,n)];return{name:"Expand",shaderCache:{hint:`${n.length}`,inputDependencies:["rank"]},getShaderSource:d,getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:p})}},al=e=>{Mp(e.inputs),e.compute(Wp(e.inputs),{inputs:[0]})}});var Np,sl,ul=j(()=>{"use strict";me();Se();$e();ri();Np=e=>{let t=e[0].dataType,r=D.size(e[0].dims),n=D.size(e[1].dims),i=n%4===0,s=o=>{let d=M("x",t,[1],4),p=M("bias",t,[1],4),m=K("y",t,[1],4),l=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],g=$=>`
    ...
    ${o.mainStart(dr)}
      ...
      ${b.mainStart()}
        ...
        ${I}
      }`};return{name:"Gather",shaderCache:{hint:t.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:l}),getShaderSource:g}},ll=e=>we({axis:e.axis}),dl=(e,t)=>{let r=e.inputs;Vp(r),e.compute(Gp(e.inputs,t))}});var Hp,Lp,pl,fl,ml=j(()=>{"use strict";me();Se();Ye();$e();Hp=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${p}`,inputDependencies:g},getRunData:()=>({outputs:[{dims:i,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:l}),getShaderSource:$},{inputs:[t[0],b]})},bl=(e,t)=>{t.format==="NHWC"?Yp(e,e.inputs,t):e.compute(jp(e.inputs,t))}});var Xp,Zp,vl,$l=j(()=>{"use strict";me();Se();$e();Xp=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},Zp=(e,t,r)=>{let n=e[0].dims,i=e[1],s=e[2],o=n,d=D.normalizeAxis(t.axis,n.length),p=D.sizeToDimension(n,d),m=D.sizeFromDimension(n,d),l=D.size(i.dims),g=s?D.size(s.dims):0;if(l!==m||s&&g!==m)throw new Error(`Size of X.shape()[axis:] == ${m}.
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:d,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:m}),getShaderSource:l},{inputs:[t,r],outputs:[-1]})[0]},ya=(e,t,r,n,i,s,o,d)=>{let p=s;if(o){if(n===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return p=tf(e,s,o,t,n,r*i,d),p=p.reshape([t,n,r,i]),e.compute(St(p,Cl.perm),{inputs:[p],outputs:[-1]})[0]}else return s.dims.length===3&&(p=s.reshape([t,n,r,i])),e.compute(St(p,Cl.perm),{inputs:[p],outputs:[-1]})[0]},Al=(e,t)=>{let r=ef(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(e.inputs[1]?.dims.length===5)throw new Error("Packed KV is not implemented");let n=e.inputs[1]&&e.inputs[2]&&e.inputs[1].dims.length===4&&e.inputs[2].dims.length===4,i=ya(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,e.inputs[0],e.inputs[3],0);if(n)return Jn(e,i,e.inputs[1],e.inputs[2],e.inputs[4],void 0,void 0,void 0,e.inputs[5],r,t);let s=ya(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.headSize,e.inputs[1],e.inputs[3],r.hiddenSize),o=ya(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.vHeadSize,e.inputs[2],e.inputs[3],2*r.hiddenSize);Jn(e,i,s,o,e.inputs[4],void 0,e.inputs[6],e.inputs[7],e.inputs[5],r,t)}});var rf,nf,af,of,sf,uf,lf,df,El,Ol=j(()=>{"use strict";me();Se();$e();rf=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},nf=(e,t,r)=>{let n="";for(let i=t-1;i>=0;--i)n+=`
      ...
      `},af=(e,t,r)=>{let n="";for(let i=t-1;i>=0;--i)n+=`
          ...
          `},uf=(e,t,r)=>{switch(r.mode){case 0:return nf(e,t,r.pads.length);case 1:return af(e,t,r.pads.length);case 2:return of(e,t,r.pads.length);case 3:return sf(e,t,r.pads.length);default:throw new Error("Invalid mode")}},lf=(e,t)=>{let r=D.padShape(e[0].dims.slice(),t.pads),n=e[0].dims,i=D.size(r),s=[{type:12,data:i},{type:6,data:t.pads}];t.mode===0&&s.push({type:e[0].dataType,data:t.value}),s.push(...X(e[0].dims,r));let o=["rank"],d=p=>{let m=K("output",e[0].dataType,r.length),l=M("x",e[0].dataType,n.length),g=l.type.value,b=uf(m,n.length,t),$=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&$.push({name:"constant_value",type:g}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},zl=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,cf=e=>`${zl(e)};${e.countIncludePad}`,pf=e=>`${zl(e)};${e.storageOrder};${e.dilations}`,Bl=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),Dl=(e,t,r,n)=>{let[i,s]=kl(t,n,r),o=M("x",t.dataType,t.dims.length),d=o.type.value,p="value += x_val;",m="";i.countIncludePad?m+=`value /= ${d}(uniforms.kernelSize);`:m+=`value /= ${d}(i32(uniforms.kernelSize) - pad);`;let[l,g,b,$,v]=Pl(s,i);l.push(...X(t.dims,s));let S=["rank"];return{name:e,shaderCache:{hint:`${n.cacheKey};${b};${$};${v}`,inputDependencies:S},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(D.size(s)/64)},programUniforms:l}),getShaderSource:T=>Rl(T,o,t.dims.length,s.length,i,p,m,0,g,b,$,v)}},Ml=e=>{let t=e.count_include_pad!==0,r=Bl(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let n={countIncludePad:t,...r,cacheKey:""};return{...n,cacheKey:cf(n)}},Ul=(e,t)=>{di(e.inputs),e.compute(Dl("AveragePool",e.inputs[0],!1,t))},Wl={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},Nl=e=>{let t=e.format;return{format:t,...Wl,cacheKey:t}},Vl=(e,t)=>{di(e.inputs),e.compute(Dl("GlobalAveragePool",e.inputs[0],!0,t))},Gl=(e,t,r,n)=>{let[i,s]=kl(t,n,r),o=`
      value = max(x_val, value);
    `,d="",p=M("x",t.dataType,t.dims.length),m=["rank"],[l,g,b,$,v]=Pl(s,i);return l.push(...X(t.dims,s)),{name:e,shaderCache:{hint:`${n.cacheKey};${b};${$};${v}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(D.size(s)/64)},programUniforms:l}),getShaderSource:S=>Rl(S,p,t.dims.length,s.length,i,o,d,t.dataType===10?-65504:-1e5,g,b,$,v)}},Hl=(e,t)=>{di(e.inputs),e.compute(Gl("MaxPool",e.inputs[0],!1,t))},Ll=e=>{let t=e.storage_order,r=e.dilations,n=Bl(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(n.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let i={storageOrder:t,dilations:r,...n,cacheKey:""};return{...i,cacheKey:pf(i)}},Fl=e=>{let t=e.format;return{format:t,...Wl,cacheKey:t}},ql=(e,t)=>{di(e.inputs),e.compute(Gl("GlobalMaxPool",e.inputs[0],!0,t))}});var mf,hf,Kl,Yl=j(()=>{"use strict";_t();me();$e();mf=(e,t,r)=>{let n=e===t,i=e<t&&r<0,s=e>t&&r>0;if(n||i||s)throw new Error("Range these inputs' contents are invalid.")},hf=(e,t,r,n)=>{let i=Math.abs(Math.ceil((t-e)/r)),s=[i],o=i,d=[{type:12,data:o},{type:n,data:e},{type:n,data:r},...X(s)],p=m=>{let l=K("output",n,s.length),g=l.type.value,b=[{name:"outputSize",type:"u32"},{name:"start",type:g},{name:"delta",type:g}];return`
        ${m.registerUniforms(b).declareVariables(l)}
        ${m.mainStart()}
        ${m.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${g}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${n}`},getShaderSource:p,getRunData:()=>({outputs:[{dims:s,dataType:n}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:d})}},Kl=e=>{let t=0,r=0,n=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],n=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],n=e.inputs[2].getFloat32Array()[0]),Ee.webgpu.validateInputContent&&mf(t,r,n),e.compute(hf(t,r,n,e.inputs[0].dataType),{inputs:[]})}});var gf,yf,bf,wf,vf,$f,_f,Sf,xf,Cf,If,Xl,Af,Tf,Ef,Of,kf,Zl,Ql,Jl=j(()=>{"use strict";me();Se();Ye();$e();gf=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
      ...
      }`},x=[{dims:o,dataType:e[0].dataType}];return r>1&&x.push({dims:m,dataType:1}),r>2&&x.push({dims:m,dataType:1}),r>3&&x.push({dims:i,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${S};${b};${$};${v}`,inputDependencies:e.map((O,A)=>"type")},getShaderSource:I,getRunData:()=>({outputs:x,dispatchGroup:{x:Math.ceil(d/p/64)},programUniforms:T})}},rd=(e,t)=>{zf(e.inputs);let n=[0];e.outputCount>1&&n.push(-3),e.outputCount>2&&n.push(-3),e.outputCount>3&&n.push(3),e.compute(Bf(e.inputs,t,e.outputCount,!1),{outputs:n})}});var Df,ci,Mf,id,Uf,Wf,ad,od,sd=j(()=>{"use strict";me();Se();Ye();$e();Df=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,n)=>{if(e[n+1].dataType!==6&&e[n+1].dataType!==7)throw new Error(`Input ${n} must be an array of int32 or int64`)})},ci=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(n=>r.push(Number(n)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(n=>r.push(Number(n)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},Mf=(e,t)=>{if(e.length>1){let r=ci(e,1),n=ci(e,2),i=ci(e,3);return i.length===0&&(i=[...Array(e[0].dims.length).keys()]),we({starts:r,ends:n,axes:i})}else return t},id=(e,t,r,n,i)=>{let s=e;return e<0&&(s+=r[n[t]]),i[t]<0?Math.max(0,Math.min(s,r[n[t]]-1)):Math.max(0,Math.min(s,r[n[t]]))},Uf=(e,t,r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${p.length}_${o.length}_${s.length}`,inputDependencies:["rank"]},getShaderSource:T,getRunData:()=>({outputs:[l],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:S})}},ad=(e,t)=>{Df(e.inputs,t);let r=Mf(e.inputs,t);e.compute(Wf(e.inputs,r),{inputs:[0]})},od=e=>{let t=e.starts,r=e.ends,n=e.axes;return we({starts:t,ends:r,axes:n})}});var Nf,Vf,ud,ld,dd=j(()=>{"use strict";me();Se();Ye();$e();Nf=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},Vf=(e,t)=>{let r=e.dims,n=D.size(r),i=64,s=t.axis;if(s<0&&(s=r.length+s),s<r.length-1)throw new Error("softmax only supports last axis for now.");let o=r[s],d=n/o,p=Ve(o),m=o/p,l=(T,I)=>I===4?`max(max(${T}.x, ${T}.y), max(${T}.z, ${T}.w))`:I===2?`max(${T}.x, ${T}.y)`:I===3?`max(max(${T}.x, ${T}.y), ${T}.z)`:T,g=M("x",e.dataType,e.dims,p),b=K("result",e.dataType,e.dims,p),$=g.type.value,v=De(e.dataType)==="f32"?`var threadMax = ${$}(-3.402823e+38f);`:`var threadMax = ${$}(-65504.0h);`,S=T=>`
      ...
      }`;return{name:"Softmax",shaderCache:{hint:`${p}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:r,dataType:e.dataType}],dispatchGroup:{x:d},programUniforms:[{type:6,data:m}]}),getShaderSource:S}},ud=(e,t)=>{Nf(e.inputs),e.compute(Vf(e.inputs[0],t))},ld=e=>we({axis:e.axis})});var Gf,Hf,Lf,Ff,qf,cd,pd,fd=j(()=>{"use strict";me();Se();Ye();$e();Gf=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Hf=(e,t)=>{let r=[],n=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(i=>r.push(Number(i))),n=r.length),we({numOutputs:n,axis:t.axis,splitSizes:r})},Lf=e=>`
...
`)}
  ...
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getShaderSource:$,getRunData:()=>({outputs:m,dispatchGroup:{x:Math.ceil(n/64)},programUniforms:b})}},cd=(e,t)=>{Gf(e.inputs);let r=e.inputs.length===1?t:Hf(e.inputs,t);e.compute(qf(e.inputs,r),{inputs:[0]})},pd=e=>{let t=e.axis,r=e.splitSizes,n=e.numOutputs<0?r.length:e.numOutputs;if(n!==r.length)throw new Error("numOutputs and splitSizes lengh must be equal");return we({axis:t,numOutputs:n,splitSizes:r})}});var md,jf,Kf,Yf,hd,gd=j(()=>{"use strict";me();Se();$e();md=e=>Array.from(e.getBigInt64Array(),Number),jf=e=>{if(!e||e.length!==2)throw new Error("Tile requires 2 inputs.");if(e[0].dataType!==1&&e[0].dataType!==6&&e[0].dataType!==12)throw new Error("Tile only support float, int32, and uint32 data types");if(e[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(md(e[1]).length!==e[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},Kf=(e,t)=>{let r=[];for(let n=0;n<e.length;++n)r.push(e[n]*t[n]);return r},Yf=e=>{let t=e[0].dims,r=md(e[1]),n=Kf(t,r),i=D.size(n),s=e[0].dataType,o=M("input",s,t.length),d=K("output",s,n.length),p=m=>`
