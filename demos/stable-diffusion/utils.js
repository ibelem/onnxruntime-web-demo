...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    || location.href.toLowerCase().indexOf('webai.run') > -1) {
        path = 'webml/models/resolve/main/stable-diffusion/tokenizer';        
    } else {
        path = '../../demos/stable-diffusion/models/tokenizer/'
    }
...
export const modelPath = () => {
    ...
    || location.href.toLowerCase().indexOf('netlify.app') > -1
    || location.href.toLowerCase().indexOf('webai.run') > -1) {
        return 'https://huggingface.co/webml/models/resolve/main/stable-diffusion/';
    } else {
        return 'models/'
    }
}
